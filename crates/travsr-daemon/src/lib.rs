...
# Third-party vendored dependencies (Go/PHP, CocoaPods, Carthage, JS)
vendor/
Pods/
Carthage/
node_modules/
# Common build output directories (generic, Rust/Gradle, SwiftPM)
build/
target/
.build/
# Generated code
...
const DEFAULT_TRAVSRIGNORE_RULE_COUNT: usize = 10;
