...
//!
//! NOTE: travsr-plugin-host::phase_b::catalog is provided by the parallel
//! P5-S1 agent. Until that crate is merged the catalog import below uses a
//! local stub so this crate compiles independently.
...
// ---------------------------------------------------------------------------
// Catalog shim — replaced by the real travsr-plugin-host import once merged.
// TODO(P5-S1): replace this entire block with:
...
/// Built-in Phase B catalog — 13 languages.
/// Source of truth: ADR-017 §3 "Phase B Language Matrix".
pub static CATALOG: &[PhaseBEntry] = &[
    ...
    PhaseBEntry {
        ...
        install_hint: "Install Eclipse JDT LS: https://github.com/eclipse-jdtls/eclipse.jdt.ls",
    },
    PhaseBEntry {
        language: "kotlin",
        ...
        sandbox: SandboxRequirement::RequiresElevated,
        install_hint:
            "Install kotlin-language-server: https://github.com/fwcd/kotlin-language-server",
    },
    PhaseBEntry {
        language: "csharp",
        command: "OmniSharp",
        ...
        output_format: OutputFormat::Lsif,
        sandbox: SandboxRequirement::RequiresElevated,
        install_hint: "Install OmniSharp: https://github.com/OmniSharp/omnisharp-roslyn",
    },
    PhaseBEntry {
        language: "scala",
        command: "metals",
        ...
        output_format: OutputFormat::Lsif,
        sandbox: SandboxRequirement::RequiresElevated,
        install_hint: "Install Metals: https://scalameta.org/metals/",
    },
    PhaseBEntry {
        language: "ruby",
        command: "solargraph",
    ...
    PhaseBEntry {
        ...
        output_format: OutputFormat::Lsif,
        sandbox: SandboxRequirement::Standard,
        install_hint: "Install clangd: https://clangd.llvm.org/installation",
    },
    PhaseBEntry {
        language: "c",
        command: "clangd",
